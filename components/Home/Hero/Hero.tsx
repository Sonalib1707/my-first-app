    ...
    return (
        ...
        flex justify-center flex-col'>
            <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
                {/** text content */}
                <div>
                    <p className='text-sm sm:text-base md:text-xl font-bold'>Make the smarted purchase</p>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem] 
                    md:leading-[3.5rem]'>
                        Kickstart,Scale and Thrive faster with <span className='text-red-700'>TechDev</span>
                    </h1>
                    <p className='text-xs sm:text-sm md:text-base font-medium text-gray-700'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem vero quidem, quasi, eum molestias assumenda laborum delectus, quibusdam sunt eaque consequuntur sed voluptas voluptatibus ipsam atque? Placeat numquam deserunt magnam.</p>
                    {/** ratings*/}
                    <div className='flex sm:flex-row sm:items-center sm:space-x-10 mt-6'>
                            ...
                            <div>
                                <div className='flex items-center space-x-2'>
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <FaStar className='w-4 h-4 text-yellow-500' />
                                        <FaStar className='w-4 h-4 text-yellow-500' />
                                        <FaStarHalf className='w-4 h-4 text-yellow-500' />
                                    </div>
                                </div>
